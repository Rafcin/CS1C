...
//It's hard to get back into C++, looking at Java and Python for a year and half really makes you spoiled.
...
void Employee::addToAge(int _age) {
    std::cout << "Added " + std::to_string(_age) + " Years To Age." << std::endl;
    age = age + _age;
}

std::ostream &operator<<(std::ostream &os, const Employee &employee) {
    os << "name: " << employee.name << " id: " << employee.id << " phone: " << employee.phone << " age: "
       << employee.age << " gender: " << employee.gender << " title: " << employee.title << " salary: "
       << employee.salary << " hired: " << employee.hired.asString();
    return os;
}
...
bool Employee::operator<(const Employee &rhs) const {
    ...
    if (salary < rhs.salary)
        return true;
    if (rhs.salary < salary)
        return false;
    return hired.asString() < rhs.hired.asString();
}
